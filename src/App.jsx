...
function App() {
  ...
  return (
    <div>
      ...
      <button
        className="fixed bottom-6 left-6 z-40 p-2 bg-blue-600 text-white rounded-full shadow-lg animate-bounce hover:scale-110 transition-transform duration-300"
